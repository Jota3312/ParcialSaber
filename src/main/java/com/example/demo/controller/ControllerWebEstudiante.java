...
public class ControllerWebEstudiante {
    ...
    public String estudianteResultadoTotalTemplate(Model model, HttpSession session) {
        ...
        if (estudiante == null) {
            // Redirigir a la página de login si el estudiante no está logeado
        ...
        return "estudiante-resultado-total"; // Asegúrate de que esta plantilla exista
    }
    ...
    public String estudianteResultadoUnicoTemplate(Model model, HttpSession session) {
        ...
        return "estudiante-resultado"; // Asegúrate de que esta plantilla exista
    }
    ...
    public String estudianteIndexTemplate(Model model, HttpSession session) {
        ...
        return "index-estudiante"; // Asegúrate de que esta plantilla exista
    }
    ...
    public String estudianteLogearTemplate(@RequestParam String usuario, @RequestParam String contrasena, Model model, HttpSession session) {
        ...
        Estudiante estudiante = estudianteRepository.findByUsuario(usuario); // Asumiendo que tienes este método en el repositorio
        ...
        if (estudiante != null && estudiante.getContrasena().equals(contrasena)) {
            ...
            return "redirect:/estudiante/resultadoUnico"; // Cambiar a la página de resultado deseada
        } else {
    ...
    public String estudianteLoginTemplate(Model model) {
        return "login-estudiante"; // Asegúrate de que esta plantilla exista
    }
}
